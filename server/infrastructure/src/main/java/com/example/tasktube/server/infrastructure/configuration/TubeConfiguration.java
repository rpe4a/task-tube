...
public class TubeConfiguration {
    ...
    public ITubeService registerTubeService(final ITubeRepository repository, final IBarrierRepository barrierRepository) {
        return new TubeService(repository, barrierRepository);
    }
}
