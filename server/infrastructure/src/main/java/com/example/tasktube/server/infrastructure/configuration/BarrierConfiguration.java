...
public class BarrierConfiguration {
    ...
    public IBarrierService registerBarrierService(final IBarrierRepository barrierRepository, final ITaskRepository taskRepository, final IEventPublisher eventPublisher) {
        return new BarrierService(barrierRepository, taskRepository, eventPublisher);
    }
}
